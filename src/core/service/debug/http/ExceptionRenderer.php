...
namespace eiu\core\service\debug\http;
...
class ExceptionRenderer
{
     ...
     *
     * @internal param bool $inDevelopmentEnvironment Whether or not we are in the development environment
     */
    public function __construct(Application $app)
    {
        $this->inDevelopmentEnvironment = ($app['config']['app']['RUN_MODE'] == 'debug');
    }
