...
namespace eiu\components\image\Adapter;


use eiu\components\image\Adjust;
use eiu\components\image\Color;
use eiu\components\image\Draw;
use eiu\components\image\Effect;
use eiu\components\image\Filter;
use eiu\components\image\ImageException;
use eiu\components\image\Layer;
use eiu\components\image\Type;
...
class Gd extends AbstractAdapter
{
    ...
    public function load($name = null)
    {
        ...
        {
            throw new ImageException('The image file has not been passed to the image adapter');
        }
        ...
        {
            throw new ImageException('The image file must be a GIF, PNG or JPG');
        }
        
        if ($this->resource === false)
        {
            throw new ImageException('Unable to load image resource');
        }
    ...
    public function create($width = null, $height = null, $name = null)
    {
        ...
        {
            throw new ImageException('You must pass a width and a height');
        }
        ...
        if ($this->resource === false)
        {
            throw new ImageException('Unable to create image resource');
        }
    ...
    public function createColor(Color\ColorInterface $color = null, $alpha = null)
    {
        ...
        if (null !== $alpha)
        {
            ...
            {
                throw new \OutOfRangeImageException('The alpha parameter must be between 0 and 127');
            }
    ...
    public function convert($to)
    {
        ...
        {
            throw new ImageException('The image type must be a GIF, PNG or JPG');
        }
        
        if (null === $this->resource)
        {
            throw new ImageException('An image resource has not been created or loaded');
        }
    ...
    public function writeToFile($to = null, $quality = 100)
    {
        ...
        {
            throw new \OutOfRangeImageException('The quality parameter must be between 0 and 100');
        }
