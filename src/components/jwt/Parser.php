...
use eiu\components\jwt\Claim\Factory as ClaimFactory;
use eiu\components\jwt\Parsing\Decoder;
use \Exception;
...
class Parser
{
     ...
     * @return array
     *
     * @throws \Exception When JWT is not a string or is invalid
     */
    protected function splitJwt($jwt)
    {
        if (!is_string($jwt))
        {
            throw new \Exception('The JWT string must have two dots');
        }
     ...
     * @return array
     *
     * @throws \Exception When an invalid header is informed
     */
    protected function parseHeader($data)
    {
        ...
        if (isset($header['enc']))
        {
            throw new \Exception('Encryption is not supported yet');
        }
