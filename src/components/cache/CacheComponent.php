...
use ArrayAccess;
use eiu\components\cache\adapter\ICacheAdapter;
...
class CacheComponent extends Component implements ArrayAccess
{
     ...
     * @throws \Exception
     */
    public function __construct(Application $app, ConfigProvider $config, ICacheAdapter $adapter)
    {
     ...
     * @param ICacheAdapter $adapter
     */
    public function setupAdapter(Adapter\ICacheAdapter $adapter)
    {
